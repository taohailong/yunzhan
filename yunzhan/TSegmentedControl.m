...
- (CGRect)frameForSelectionIndicator {
    ...
    {
       return CGRectMake(self.segmentWidth * self.selectedIndex, self.bounds.size.height-1, self.segmentWidth, self.selectionIndicatorHeight);
    }
    else {
